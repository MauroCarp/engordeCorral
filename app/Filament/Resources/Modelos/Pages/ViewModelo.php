...
class ViewModelo extends ViewRecord
{
    ...
    {
        return 'Análisis Económico - ' . ($this->record->nombre ?? 'Modelo');
    }

    public function getCalculos(): array
    {
        $modelo = $this->record;
    ...
    private function calcularMetricas($modelo, $costoSanidad, $costoEstructura): array
    {
        // Datos básicos
        ...
        $consumoDiario = $pesoPromedio * $modelo->consumo_promedio_ms;
